    ...
    <nav class="site-navbar" id="siteNavbar">
        <div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
            ...
            <div class="flex items-center gap-4">
                @auth
                    <a href="{{ route('dashboard') }}" class="bg-brand-blue hover:bg-blue-700 text-white text-sm font-semibold px-5 py-2.5 rounded-xl flex items-center gap-2 shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition duration-200">
                        <span>Dashboard</span>
                ...
                @else
                    <a href="{{ route('login') }}" class="border border-white/20 hover:border-brand-sky bg-white/10 hover:bg-white/20 text-white text-sm font-semibold px-5 py-2.5 rounded-xl flex items-center gap-2 transform hover:scale-105 transition duration-200 shadow-sm">
                        <span>Login</span>
                        <svg class="h-4.5 w-4.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
        ...
        <div class="max-w-7xl mx-auto px-6 py-24 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center w-full z-10">
            ...
            <div class="lg:col-span-6 space-y-6 text-left animate-slide-up">
                ...
                <div class="flex flex-wrap gap-4 pt-2">
                    @auth
                        <a href="{{ route('dashboard') }}" class="bg-brand-blue hover:bg-blue-700 text-white font-bold px-8 py-4 rounded-2xl shadow-lg shadow-blue-600/20 transform hover:-translate-y-1 transition duration-300 text-sm">
                            Enter Portal
                        </a>
                    @else
                        <a href="{{ route('login') }}" class="bg-brand-blue hover:bg-blue-700 text-white font-bold px-8 py-4 rounded-2xl shadow-lg shadow-blue-600/20 transform hover:-translate-y-1 transition duration-300 text-sm">
                            Sign In to Portal
                        </a>
                        <a href="{{ route('register') }}" class="bg-white/10 hover:bg-white/20 border border-white/20 hover:border-brand-sky text-white font-bold px-8 py-4 rounded-2xl transition duration-200 text-sm shadow-sm transform hover:-translate-y-0.5 backdrop-blur-sm">
                            Create Account
                        </a>
                    @endauth
                </div>

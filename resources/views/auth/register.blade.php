...
<body class="min-h-screen flex items-center justify-center p-4 text-slate-200 relative">
    ...
    <div class="w-full max-w-xl clean-card rounded-3xl p-8 my-8 relative">
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        ...
                        <div>
                            ...
                            <select id="gender" name="gender"
                                ...
                                <option value="MALE" {{ old('gender') === 'MALE' ? 'selected' : '' }} class="bg-[#090d16]">Male</option>
                                <option value="FEMALE" {{ old('gender') === 'FEMALE' ? 'selected' : '' }} class="bg-[#090d16]">Female</option>
                                <option value="OTHER" {{ old('gender') === 'OTHER' ? 'selected' : '' }} class="bg-[#090d16]">Other</option>
                            </select>
                        </div>
                    </div>
        ...
        <div class="mt-6 text-center">
            ...
            <a href="{{ route('login') }}" class="text-xs text-hospital-500 hover:text-hospital-600 font-semibold underline">
                Back to Sign In
            </a>
        </div>
    </div>

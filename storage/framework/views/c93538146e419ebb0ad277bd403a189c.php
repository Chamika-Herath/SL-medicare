...
<body class="min-h-screen flex items-center justify-center p-4 text-slate-200 relative">
    ...
    <div class="w-full max-w-md clean-card rounded-3xl p-8 relative">
        ...
        <div class="mt-6 text-center">
            ...
            <a href="<?php echo e(route('register')); ?>" class="text-xs text-hospital-500 hover:text-hospital-600 font-semibold underline">
                Create an account
            </a>
        </div>
...
<?php /**PATH C:\Users\hmcdi\OneDrive\Documents\GITHUB\cloud_hospital_system\resources\views/auth/login.blade.php ENDPATH**/ ?>
...
<div class="grid grid-cols-1 xl:grid-cols-3 gap-6 items-start">
    ...
    <div class="bg-[#0d131f] border border-slate-800 rounded-2xl p-6 shadow-lg xl:col-span-1">
        ...
        <form action="<?php echo e(route('records.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-4">
            <?php echo csrf_field(); ?>
            <div>
                ...
                <select id="patient_id" name="patient_id" required
                    ...
                    <?php $__currentLoopData = $patients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($pat->id); ?>" class="bg-[#0d131f]">
                            <?php echo e($pat->profile->full_name ?? $pat->email); ?> 
                            (DOB: <?php echo e($pat->profile->dob ?? 'N/A'); ?>)
                        </option>
    ...
    <div class="bg-[#0d131f] border border-slate-800 rounded-2xl p-6 shadow-lg <?php echo e((Auth::user()->role === 'DOCTOR' || Auth::user()->role === 'ADMIN') ? 'xl:col-span-2' : 'xl:col-span-3'); ?>">
                ...
                <?php $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-[#131a26]/70 border border-slate-800 p-5 rounded-2xl space-y-3 hover:border-blue-500/50 transition duration-300">
                        ...
                        <div class="flex justify-between items-start gap-4">
                            <div>
                                <h4 class="text-md font-bold text-white"><?php echo e($rec->diagnosis); ?></h4>
                                <div class="text-xs text-slate-400 mt-0.5 font-medium">
                                    Patient: <span class="text-brand-sky font-semibold"><?php echo e($rec->patient->profile->full_name ?? 'N/A'); ?></span> 
                                    (DOB: <?php echo e($rec->patient->profile->dob ?? 'N/A'); ?>)
                                </div>
                                <div class="text-xs text-slate-500 mt-0.5 font-medium">
                                    Consultant: <?php echo e($rec->doctor->profile->full_name ?? 'N/A'); ?>
                            ...
                            <div class="pt-2 border-t border-slate-800">
                                ...
                                <div class="flex flex-wrap items-center gap-3">
                                    ...
                                    <?php if(preg_match('/\.(jpg|jpeg|png|gif)/i', $rec->image_url)): ?>
                                        <a href="<?php echo e($rec->image_url); ?>" target="_blank" class="group relative overflow-hidden rounded-lg border border-slate-800 hover:border-brand-sky/40 shrink-0">
                                            <img src="<?php echo e($rec->image_url); ?>" alt="Diagnostic Scan" class="h-16 w-16 object-cover group-hover:scale-105 transition duration-200">
                                    ...
                                    <a href="<?php echo e($rec->image_url); ?>" target="_blank"
...
<?php echo $__env->make('layouts.portal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hmcdi\OneDrive\Documents\GITHUB\cloud_hospital_system\resources\views/records.blade.php ENDPATH**/ ?>
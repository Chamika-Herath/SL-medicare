...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
    ...
    <div class="bg-[#0d131f] border border-slate-800 rounded-2xl p-6 shadow-lg">
        ...
        <div class="space-y-3">
            ...
            <?php elseif($latestRecords->isEmpty()): ?>
                <div class="text-center py-8 text-slate-500 text-sm">
...
<?php echo $__env->make('layouts.portal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hmcdi\OneDrive\Documents\GITHUB\cloud_hospital_system\resources\views/dashboard.blade.php ENDPATH**/ ?>